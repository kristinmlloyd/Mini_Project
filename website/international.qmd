...
killed = int(df['nationals_killed'].sum() + df['internationals_killed'].sum())
wounded = int(df['nationals_wounded'].sum() + df['internationals_wounded'].sum())
kidnapped = int(df['nationals_kidnapped'].sum() + df['internationals_kidnapped'].sum())

from IPython.display import HTML

html = f"""
<div>
  <span class="typing-line">Since 1997...</span>
