...
The chart reveals differences in the frequency of incidents attributed to each actor type, which provides important context for understanding the sources of security threats in the region. This has implications for:

1. **Responsibility patterns**: The data helps identify key actors in the conflict based on incident attribution.
...
3. **Accountability**: Understanding which actors are responsible for incidents has implications for accountability and human rights monitoring.
