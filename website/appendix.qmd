...
- [**Data Cleaning**](data_cleaning.qmd)  
  Details on how the raw data was processed and standardized for analysis, including missing value handling and variable selection.

- [**International Analysis**](international.qmd)  
  A global-level overview comparing trends, attack types, and humanitarian impact across multiple conflict-affected countries.
